...
export const pulse: ServiceDef = {
  ...
  tools: [
    ...
    {
      name: "xrpl_pulse_xrpl_primitives",
      description:
        "Free. " +
        "Ledger-wide XRPL object counts: PermissionedDomain, Credential, DID, Oracle, " +
        "MPTokenIssuance, AMM, Escrow, DepositPreauth, Check, PayChannel, NFTokenPage and more, " +
        "plus canonical XRP supply (total, burned, escrowed, circulating) and AMM aggregates. " +
        "This is the denominator for any XRPL adoption claim: counts are of ledger OBJECTS, not " +
        "of distinct operators or issuers. Sampled once per UTC day, with day-over-day, 7d and " +
        "30d deltas and the full series.",
      inputSchema: {
        type: "object",
        properties: {
          window_days: {
